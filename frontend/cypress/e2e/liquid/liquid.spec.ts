  ...
  if (baseModule === 'liquid') {
    ...
    describe('unblinded TX', () => {
      ...
      it('show unblinded TX', () => {
        ...
        cy.waitForSkeletonGone();
        cy.get('.table-tx-vin tr:nth-child(1) .amount').should('contain.text', '0.02465000 L-B1T');
        cy.get('.table-tx-vin tr').should('have.class', 'assetBox');
        cy.get('.table-tx-vout tr:nth-child(1) .amount').should('contain.text', '0.00100000 L-B1T');
        cy.get('.table-tx-vout tr:nth-child(2) .amount').should('contain.text', '0.02364760 L-B1T');
