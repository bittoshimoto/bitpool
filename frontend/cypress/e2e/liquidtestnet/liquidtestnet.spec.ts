  ...
  if (baseModule === 'liquid') {
    ...
    describe('unblinded TX', () => {
      ...
      it('show unblinded TX', () => {
        ...
        cy.waitForSkeletonGone();
        cy.get('.table-tx-vin tr:nth-child(1) .amount').should('contain.text', '0.00100000 tL-B1T');
        cy.get('.table-tx-vin tr').should('have.class', 'assetBox');
        cy.get('.table-tx-vout tr:nth-child(1) .amount').should('contain.text', '0.00050000 tL-B1T');
        cy.get('.table-tx-vout tr:nth-child(2) .amount').should('contain.text', '0.00049741 tL-B1T');
      ...
      it('show first unblinded vout', () => {
        ...
        cy.get('.table-tx-vout tr:nth-child(1) .amount').should('contain.text', '0.00099729 tL-B1T');
      });
